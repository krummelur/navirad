    ...
    return (
        <div className="view-menu-container">
            ...
            <div className="slider-outer">
                ...
                <StyledTooltip title="Beam width changes the width of the radio wave. Real radars have a limited width, usually 2-6°. Details are lost within a beam, as a beam only returns one echo." placement="left">
            ...
            <div className="medium-text">Other properties:
                <ul className="ks-cboxtags">
                    <StyledTooltip title="Rain clutter simulates interference from heavy rain. When the radar beam hits rain, it echoes and it shows up as clutter on the screen." placement="left">
                        <li>
                    ...
                    <StyledTooltip title="Radar/map overlay overlays a map on the radar. There are some differences in map content between the heightmap and the actual map, why some islands don't appear on the radar." placement="left">
                        <li>
                    ...
                    <StyledTooltip title="Shows other boats on the radar via the AIS protocol. The boats shown are actual real life boats and their real position (with some limitations in update frequency)" placement="left">
                        <li>
            ...
            <div className="joystick-area">
                <p>Click and drag in the joystick area<br/>to control the radars position.</p>
